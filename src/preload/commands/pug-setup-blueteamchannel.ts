...
export const name = "pug-blue";
export const description = "Sets a channel to be the designated blue team channel.";
...
export async function run(bot: Bot, msg: Message) {
    ...
    Server.findOne({
        ...
        (server.pugging as any).blueTeamChannelID = channel.id;
        ...
        server.save(err => {
            ...
            msg.channel.send("Set blue team channel to `" + channel.name + "`.");
        });
    });
}