...
export const name = "pug-picking";
export const description = "Sets a channel to be the designated picking channel.";
...
export async function run(bot: Bot, msg: Message) {
    ...
    Server.findOne({
        ...
        (server.pugging as any).pickingChannelID = channel.id;
        ...
        server.save(err => {
            ...
            msg.channel.send("Set picking channel to `" + channel.name + "`.");
        });
    });
}