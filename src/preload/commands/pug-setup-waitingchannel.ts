...
export const name = "pug-waiting";
export const description = "Sets a channel to be the designated waiting channel.";
...
export async function run(bot: Bot, msg: Message) {
    ...
    Server.findOne({
        ...
        (server.pugging as any).waitingChannelID = channel.id;
        ...
        server.save(err => {
            ...
            msg.channel.send("Set waiting channel to `" + channel.name + "`.");
        });
    });
}